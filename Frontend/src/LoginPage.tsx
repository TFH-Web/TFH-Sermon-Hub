...
const SCENARIOS: Record<DemoScenario, ScenarioConfig> = {
    ...
    'No Access': {
        ...
        subtext: (
            <>
                Need access? Contact <strong className="subtext-green">it@tfh.org</strong> to
        ...
        alert: {
            ...
            body: (
                <>
                    ...
                    <strong className="subtext-green">user@tfh.org</strong> once access
                    is granted.
                </>
            ),
        },
    ...
    'Wrong Account': {
        ...
        alert: {
            ...
            body: (
                <>
                    You signed in with a personal Microsoft account. Sermon Hub requires
                    a <strong className="subtext-green">The Father's House work account</strong>{' '}
                    ending in @tfh.org.
                </>
            ),
        },
        primaryBtn: { show: false },
        outlineBtn: { show: true, label: 'Sign in with work account', msIcon: true },
        subtext: (
            <>
                ...
                <div className="login-body">
                    ...
                    {s.alert && (
                        <div className={`alert-box alert-${s.alert.type}`}>
                            ...
                            {s.alert.code && (
                                <p className="alert-code">{s.alert.code}</p>
                            )}
                        </div>
                    )}
                    ...
                    {s.subtext && (
                        <p className="login-subtext">{s.subtext}</p>
                    )}
                </div>
